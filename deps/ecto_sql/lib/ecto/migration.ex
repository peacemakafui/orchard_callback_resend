defmodule Ecto.Migration do
  ...
  migrations work**.
    ...
    * `:migration_timestamps` - By default, Ecto uses the `:naive_datetime` as the type,
      `:created_at` as the name of the column for storing insertion times, `:updated_at` as
  ...
  ## Options
    ...
    * `:created_at` - the name of the column for storing insertion times.
      Setting it to `false` disables the column.
    * `:updated_at` - the name of the column for storing last-updated-at times.
      Setting it to `false` disables the column.
    * `:type` - the type of the `:created_at` and `:updated_at` columns.
